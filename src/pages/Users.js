...
import UserCreate from "../components/modals/users/UserCreate";
import MoreVertIcon from '@mui/icons-material/MoreVert';
import AssignPermission from "../components/modals/users/AssignPermission";
      ...
      renderCell: (parms) => {
        return (
          <button className="modalImgBtn">
            <img
              src={`${process.env.REACT_APP_BASE_URL}/upload/user/${parms?.profile_picture}`}
            />
          </button>
        );
      },
