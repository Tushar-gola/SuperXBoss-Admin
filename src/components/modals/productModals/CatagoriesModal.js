...
import { Box, Modal, Stack, Button, Grid, FormGroup, FormControlLabel, Dialog, Slide } from "@mui/material";
...
export default function CatagoriesModal({ modalOpen, modalClose }) {
