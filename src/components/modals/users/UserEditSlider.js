...
import { Box, Drawer, List, Divider, ListItem, ListItemButton, ListItemIcon, ListItemText, Grid, Button } from '@mui/material';
...
export default function UserEditSlider({ open, onClose }) {
            ...
            <form onSubmit={handleSubmit}>
                <div className='section-userImage'>
                    ...
                    <button className='userImage' type='button'>
                        {
                            !getProfileImage.profileName ? <img src={`${process.env.REACT_APP_BASE_URL}/upload/user/${userData?.profile_picture}`} /> : <img src={getProfileImage.Url} />
                        }
                    </button>
